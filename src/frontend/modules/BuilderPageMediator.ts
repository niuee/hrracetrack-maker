...
export class TrackSegmentMediatorExperiment {
    
    private segmentMap: Map<string, BezierCurve> = new Map<string, BezierCurve>();
...
export class TrackSegmentMediator {
    ...
    drawSegments(context: CanvasRenderingContext2D, viewMode: ViewMode): void {
        this.segmentMap.forEach((segItem, ident)=>{
            if (segItem.selected && viewMode == ViewMode.EDIT) {
